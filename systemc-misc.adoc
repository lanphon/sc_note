...
sc_phase_callback_registry的register_callback只在sc_object的register_simulation_phase_callback
中得到调用：
...
==== unregister_callback
[[data::sc_phase_callback_registry::unregister_callback]]
...
unregister_callback的实现与register_callback基本一致。
